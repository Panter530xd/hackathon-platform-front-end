...
import useFoodAllergiesData from "@/utils/useFoodAllergiesData";
...
const RegistrationForm = () => {
  ...
  const academiesOptions = useAcademyData();
  const groupsQuery = useGroupsData();
  const foodsAllergiesQuery = useFoodAllergiesData();
  ...
  return (
    <div className="py-8 bg-user font-exoFont">
      ...
      >
        ...
        <div>
          <label htmlFor="group" className="text-white font-bold">
            Group
          </label>
          <select
        ...
        <div className="flex flex-col space-y-2">
          ...
          >
            ...
            {foodsAllergiesQuery &&
              foodsAllergiesQuery.allFoodsAllergies.map((food) => (
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="food_preferences" className="text-white font-bold">
            Food Preferences
          </label>
          <input
            type="text"
        ...
        <div className="relative inline-flex items-center justify-center">
          ...
          />
          <label htmlFor="accept_terms" className="ml-2 font-bold  text-white">
        ...
        <button
          ...
          className="bg-greenis border-2 border-white text-white font-exoFont font-semibold px-4 py-2 rounded-lg disabled:bg-gray-400 md:w-2/6 w-full mx-auto"
        >
