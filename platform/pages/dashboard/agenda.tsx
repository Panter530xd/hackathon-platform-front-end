...
const DashboardCreate: NextPageWithLayout = () => {
  ...
  const createAgendaItem = async (data: FormData) => {
    ...
    const response = await fetch(`${env.NEXT_PUBLIC_API_URL}/api/agenda`, {
      method: "POST",
      headers: {
        ...
        <div className="md:w-7/12 w-11/12 space-y-4 mx-auto font-exoFont pt-10">
          ...
          <div className="flex justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
                {errors.eventDurationFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
              ...
              />
               {errors.eventDurationTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
          ...
          <div className="flex  justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
               {errors.eventOpeningFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
                name="eventOpeningTo"
                rules={{ required: "To time is required" }}
              ...
              />
               {errors.eventOpeningTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
          ...
          <div className="flex justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center  space-x-2">
              ...
              {errors.findYourSpotFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              ...
              />
                 {errors.findYourSpotTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
          ...
          <div className="flex  justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
                {errors.firstRoundSessionsFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
              ...
              />
                 {errors.firstRoundSessionsTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
          ...
          <div className="flex  justify-between items-center border border-black py-2 px-4 rounded-md font-exoFont">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              {errors.secondRoundSessionsFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
              ...
              />
              {errors.secondRoundSessionsTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
        ...
        <div className="md:w-7/12 w-11/12 mx-auto max-w-screen-xl space-y-4 font-exoFont">
          ...
          <div className="flex  justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              {errors.registrationFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
                name="registrationTo"
                rules={{ required: "To time is required" }}
              ...
              />
              {errors.registrationTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
          ...
          <div className="flex  justify-between items-center border border-black py-2 px-4 rounded-md">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
                 {errors.presentationsFrom && <p className=" text-red-500 font-semibold">From time is required.</p>}
              <Controller
                control={control}
              ...
              />
               {errors.presentationsTo && <p className=" text-red-500 font-semibold">To time is required.</p>}
            </div>
          </div>
